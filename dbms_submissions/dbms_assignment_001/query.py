...
Q2='CREATE TABLE Post(user_id INT NOT NULL,post_id INTEGER PRIMARY KEY AUTOINCREMENT,post_content VARCHAR(500));'
...
Q9='INSERT INTO Post(user_id,post_content) VALUES(1,"My Second Post");'
